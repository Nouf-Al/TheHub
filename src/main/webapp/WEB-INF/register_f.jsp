		...
		<div class="content-container">
			<div class="row p-0 m-0">
				<div class="col-sm-6 p-0 left-section">
					<h1>Create An Account <span>As a Freelancer.</span></h1>
				</div>
				<div class="col p-0 right-section px-3">
					<form:form class="shadow" action="/freelancer/register" method="post"
						...
						<p>Already have an account? <a href="/freelancer/login">Login</a></p>
					</form:form>
				</div>
			</div>
		</div>
