...
<body>
	...
	<div class="row p-0 m-0">
		<div class="left-side col-6 m-0">
			<p class="caption">Register as a freelancer</p>
			<form:form action="/freelancer/register" method="post" modelAttribute="newUser">
				<div class="row">
					<div class="col-sm-6">
			...
			<p class="float-right">Already have an account? <a href="/freelancer/login">Login</a></p>
		</div>
