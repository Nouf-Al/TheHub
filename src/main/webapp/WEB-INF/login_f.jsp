...
<body>
	...
	<div class="row p-0 m-0">
		<div class="left-side col-6 m-0">
			<p class="caption">Login as a freelancer</p>
			<form:form action="/freelancer/login" method="post" modelAttribute="newLogin">
				<div class="row">
					<div class="col-sm-12">
			...
			<p class="float-right">Don't have an account? <a href="/freelancer/register">Register</a></p>
		</div>
