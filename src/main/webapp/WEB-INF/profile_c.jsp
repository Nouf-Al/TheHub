...
<body>
	...
	<div class="dashboard-container">
				...
				<div class="row mx-0">
					<div class="col-sm p-0 py-2 h-50 text-center ">
						<c:if test="${isClient eq true && client.id eq user.id }">
							<a href="/client/profile/${client.id}/edit" class="btn btn-success btn-block px-4">Edit</a>
						</c:if>
					</div>
				</div>
			</div>
		...
		<div class="row mx-0">
			<c:if test="${isClient eq true && client.id eq user.id }">
				<div class="col-sm-3 mb-4 p-0 shadow-sm left-section box">
					<div class="col p-0">
			...
			<div class="col-sm p-0 mb-4 right-section">
				<div class="row p-0 m-0 mb-4 shadow-sm box">
					<div class="col p-0">
						<div class="h4 box-title">Projects (${client.projects.size() })</div>
				...
				<c:if test="${isClient eq false}">
					<div class="row p-0 m-0 mt-4 shadow-sm box">
						<div class="col p-0">
							<div class="h4 box-title">Freelancers reviews</div>
							<div class="row m-0 box-content">
								<div class="col-12 p-2">
									<form:form action="/client/profile/${client.id}/review/create" method="post" modelAttribute="newReview">
										...
										<input type="submit" value="Send Your Review" class="btn form-btn btn-block mt-3 btn-block mt-3" />
									</form:form>
								</div>
							</div>
						</div>
				...
				<div class="row p-0 m-0 mt-4 shadow-sm box">
					<div class="col p-0">
						<div class="h4 box-title">Reviews (${client.reviewsOnClient.size()})</div>
						<div class="row m-0 box-content">
							<div class="col-12 p-2">
								<c:forEach items="${client.reviewsOnClient }" var="review">
									<div class="col-sm-12 p-2">
										<h5 class="card-title box-title bg">
											<a href="/freelancer/profile/${review.freelancer.id}" class="text-light">${review.freelancer.firstname} ${review.freelancer.lastname}</a>
